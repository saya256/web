 ...
 * @param entityB 衝突しているかどうかを確認したいエンティティ
...
function entitiesAreColliding(
  ...
  // xとy、いずれかの距離が十分に開いていたら衝突していない　=　falseを返す
...
function updateGame() {
  ...
  // ブロックの追加と削除
  if (frameCount % 120 === 1) addBloockPair(blocks); // 一定間隔で追加
